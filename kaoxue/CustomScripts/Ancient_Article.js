    ...
    $.post("../Ancient/Reading_Lists", function (data) {
        if (data) {
            ...
            for (var i = 0; i < temp.length; i++) {
                ...
                if (i == 0) {
                    html += "<li><img src=\"img/1tubiao.png\" class=\"rmxzdk\"><a target='_blank' target='_blank' class=\"rm1\"  onclick='update_viewcount(" + temp[i].id + "," + "\"" + temp[i].title + "\"" +")' title=" + temp[i].title + "> " + text + "</a></li>";
                } else if (i == 1) {
                    html += "<li><img src=\"img/2tubiao.png\" width=\"17px\" class=\"rmxzdk\"><a target='_blank' target='_blank' class=\"rm2\" onclick='update_viewcount(" + temp[i].id + "," + "\"" + temp[i].title + "\"" +")' title=" + temp[i].title + ">" + text + "</a></li>";
                } else if (i == 2) {
                    html += "<li><img src=\"img/3tubiao.png\" width=\"17px\" class=\"rmxzdk\"><a target='_blank' target='_blank' class=\"rm3\" onclick='update_viewcount(" + temp[i].id + "," + "\"" + temp[i].title + "\"" +")' title=" + temp[i].title + ">" + text + "</a></li>";
                } else {
                    html += "<li><img src=\"img/" + (i + 1) + "tbbiao.png\" width=\"17px\" class=\"rmxzdk\"><a target='_blank' target='_blank' onclick='update_viewcount(" + temp[i].id + "," + "\"" + temp[i].title + "\"" +")' title=" + temp[i].title + ">" + text + "</a></li>";
                }
