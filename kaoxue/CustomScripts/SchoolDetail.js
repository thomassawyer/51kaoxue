        ...
        if (data) {
            ...
            if (data != "]") {
                ...
                for (var i = 0; i < temp.length; i++) {
                    ...
                    //学校照片
                    $("#imgurl").attr("src", "http://www.5ihzy.com:82/"+temp[i].imgsrc);
                    //星级
                    $("#school_star").html("");
        ...
        if (data) {
            ...
            if (data != "]") {
                ...
                for (var i = 0; i < temp.length; i++) {
                    //校长介绍
                    //照片
                    $("#president_head_img").html("<img src=\"http://www.5ihzy.com:82/" + temp[i].imgsrc + "\" width=\"215\" height=\"130\" />");
                    //姓名
        ...
        if (data) {
            ...
            if (data != "]") {
                ...
                for (var i = 0; i < temp.length; i++) {
                    ...
                    //相关名校
                    html += "<a href='../SchoolDetail?id=" + temp[i].id + "&areaid=" + temp[i].areaid + "'><div class=\"correlation_elite_schools_container\"><div><div class=\"school_img\"><img src=\"http://www.5ihzy.com:82/" + temp[i].imgsrc + "\" width=\"131\" height=\"81\" /></div><div class=\"school_text\">" + text + " </div></div></div></a>";
                }
            }
            //相关名校ID, 填充代码
