            ...
            if (data != "]") {
                ...
                for (var i = 0; i < temp.length; i++) {
                    ...
                    html += "<div class=\"lxc_320\">\
                                <a target='_blank' class=\"wdk fl\" href='../Download?id=" + temp[i].id + "&cid=" + temp[i].category + "&myTitle=" + text + "'  target='_blank' ></a>\
                                <div class=\"wenbenkui fl\">\
                                    <a target='_blank' class=\"b320 font_size16 overf_com font_wb\" href='../Download?id=" + temp[i].id + "&cid=" + temp[i].category + "&myTitle=" + text + "'  target='_blank'  title='" + text + "'>" + text + "</a><br>\
                                ...
                                <div class=\"xiazai fr\" style='position:static;width:45px;height:45px;margin-right: 30px;'>\
                                    <a target='_blank' class=\"xztb2 fr\" href='../Download?id=" + temp[i].id + "&cid=" + temp[i].category + "&myTitle=" + text + "'  target='_blank' ></a>\
                                </div>\
                            </div>";
                }
            }
