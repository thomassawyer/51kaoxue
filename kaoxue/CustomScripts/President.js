        ...
        if (data) {
            ...
            if (data != "]") {
                ...
                for (var i = 0; i < temp.length; i++) {
                    ...
                    html += "<a href='../President_Special_Column?id="+temp[i].headid+"'><div class=\"data_list_container\">\
                                    <div class=\"data_list_container_left\">\
                                        <img src=\"http://www.5ihzy.com:82/" + temp[i].headimgsrc + "\" width=\"270\" height=\"200\" />\
                                    </div>\
                                    <div class=\"data_list_container_right\">\
                                        <div class=\"data_list_container_right_title\">" + temp[i].headname + "</div>\
