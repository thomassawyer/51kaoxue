    ...
    $.post("../Home/GetTest_JuniorMiddleSchool", function (data) {
        if (data) {
            ...
            for (var i = 0; i < temp.length; i++) {
                ...
                var number_str = (i + 1) + "";
                var number = number_str.length < 2 ? "0" + number_str : number_str;
                html += "<li><div class=\"zxtlianjiediv fl\"><a class=\"zxzt_btn\"><span>" + number + "</span></a>&nbsp;<a href=\"../Download?id=" + temp[i].id + "&cid=1\">" + text + "</a></div><div class=\"fl zuixinzt\"><a href=\"\">[" + time + "]</a></div></li>";
            }
...
function Banner() {
    $.post("../Home/GetBanner", { type: 1 }, function (data) {
        if (data) {
            ...
            var html1 = "";
            for (var i = 0; i < temp.length; i++) {
                //html += "<li><a href='" + temp[i].link + "'><img src='" + "http://www.5ihzy.com:82/" + temp[i].pic + "' alt='" + (i + 1) + "' title='" + (i + 1) + "' id='wows1_" + (i + 1) + "' style='width:716px; height:489px;'></a></li>";
                html += "<li><img src='" + "http://www.5ihzy.com:82/" + temp[i].pic + "' alt='" + (i + 1) + "' title='" + (i + 1) + "' id='wows1_" + (i + 1) + "' style='width:716px; height:489px;'></li>";
        ...
        if (data) {
            ...
            if (data != "]") {
                ...
                <div  class=\"ztk_div_div \">\
                    ...
                    <div class=\"xian2 fl\"><a  class=\"genduo\"><img src=\"../../img/lantb.png\" alt=\"\"></a></div>\
                </div>";
                ...
                for (var i = 0; i < temp.length; i++) {
                    var number_str = (i + 1) + "";
                    var number = number_str.length < 2 ? "0" + number_str : number_str;
                    html += "<li><a>" + number + "</a>&nbsp;<a >" + temp[i].name + "</a></li>";
