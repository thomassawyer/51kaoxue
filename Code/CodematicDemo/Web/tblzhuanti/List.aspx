<%@ Page Title="tblzhuanti" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.tblzhuanti.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="picsrc" HeaderText="picsrc" SortExpression="picsrc" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ftitle" HeaderText="ftitle" SortExpression="ftitle" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="stitle" HeaderText="stitle" SortExpression="stitle" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="daodu" HeaderText="daodu" SortExpression="daodu" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="model" HeaderText="model" SortExpression="model" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="viewstate" HeaderText="viewstate" SortExpression="viewstate" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="bigpic" HeaderText="bigpic" SortExpression="bigpic" ItemStyle-HorizontalAlign="Center"  /> 
