<%@ Page Title="tblLunwen" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.tblLunwen.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="downum" HeaderText="downum" SortExpression="downum" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="downeed" HeaderText="downeed" SortExpression="downeed" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="uploaddate" HeaderText="uploaddate" SortExpression="uploaddate" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="memoinfo" HeaderText="memoinfo" SortExpression="memoinfo" ItemStyle-HorizontalAlign="Center"  /> 
