<%@ Page Title="tblNews" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.tblNews.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="isindex" HeaderText="isindex" SortExpression="isindex" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isenable" HeaderText="isenable" SortExpression="isenable" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="type" HeaderText="type" SortExpression="type" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="viewcounts" HeaderText="viewcounts" SortExpression="viewcounts" ItemStyle-HorizontalAlign="Center"  /> 
