<%@ Page Title="tbltest" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.tbltest.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="areaid" HeaderText="areaid" SortExpression="areaid" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="subjectid" HeaderText="subjectid" SortExpression="subjectid" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="testcategory" HeaderText="testcategory" SortExpression="testcategory" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="testname" HeaderText="testname" SortExpression="testname" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="schoolid" HeaderText="schoolid" SortExpression="schoolid" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ismingxiao" HeaderText="ismingxiao" SortExpression="ismingxiao" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="isjingpin" HeaderText="isjingpin" SortExpression="isjingpin" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="istuijian" HeaderText="istuijian" SortExpression="istuijian" ItemStyle-HorizontalAlign="Center"  /> 
