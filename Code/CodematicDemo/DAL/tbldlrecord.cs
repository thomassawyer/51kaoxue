...
namespace Maticsoft.DAL
{
	...
	public partial class tbldlrecord
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tbldlrecord"); 
		}
		...
		public bool Exists(DateTime dltime,int id)
		{
			...
			strSql.Append("select count(1) from tbldlrecord");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tbldlrecord(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tbldlrecord set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tbldlrecord ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Maticsoft.Model.tbldlrecord GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,userid,category,fileid,dltime,spnum,level,filename,FK_subject_ID from tbldlrecord ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tbldlrecord DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tbldlrecord model=new Maticsoft.Model.tbldlrecord();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM tbldlrecord ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tbldlrecord T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tbldlrecord";
			parameters[1].Value = "id";
