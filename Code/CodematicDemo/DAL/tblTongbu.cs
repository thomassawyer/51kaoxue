...
namespace Maticsoft.DAL
{
	...
	public partial class tblTongbu
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tblTongbu"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tblTongbu");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.tblTongbu model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tblTongbu(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tblTongbu model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tblTongbu set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tblTongbu ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblTongbu GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,level,subjectid,versionid,name,uploadtime,filesrc,downloadnum,neednum,extension,year,uploader,content,prepareid,isjing,isgaokao,isdujia,beikao from tblTongbu ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.tblTongbu model=new Maticsoft.Model.tblTongbu();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblTongbu DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tblTongbu model=new Maticsoft.Model.tblTongbu();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tblTongbu T ");
