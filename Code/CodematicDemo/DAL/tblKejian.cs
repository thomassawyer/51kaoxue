...
namespace Maticsoft.DAL
{
	...
	/// 数据访问类:tblKejian
	/// </summary>
	public partial class tblKejian
	{
		public tblKejian()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tblKejian"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tblKejian");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.tblKejian model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tblKejian(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tblKejian model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tblKejian set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tblKejian ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblKejian GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,level,subjectid,versionid,name,uploadtime,filesrc,downloadnum,neednum,extension,year,uploader,content,prepareid,isjing,isgaokao,isdujia,beikao from tblKejian ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblKejian DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tblKejian model=new Maticsoft.Model.tblKejian();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tblKejian T ");
