...
namespace Maticsoft.DAL
{
	...
	public partial class tblMessage
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tblMessage"); 
		}
		...
		public int Add(Maticsoft.Model.tblMessage model)
		{
			...
			strSql.Append("title,content,mobile,email,pubdate,school)");
		...
		public Maticsoft.Model.tblMessage GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,title,content,mobile,email,pubdate,school from tblMessage ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblMessage DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tblMessage model=new Maticsoft.Model.tblMessage();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,content,mobile,email,pubdate,school ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,title,content,mobile,email,pubdate,school ");
			strSql.Append(" FROM tblMessage ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
