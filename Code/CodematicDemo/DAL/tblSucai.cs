...
namespace Maticsoft.DAL
{
	...
	public partial class tblSucai
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tblSucai"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tblSucai");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.tblSucai model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tblSucai(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tblSucai model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tblSucai set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tblSucai ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblSucai GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,level,subjectid,versionid,name,uploadtime,filesrc,downloadnum,neednum,extension,year,uploader,content,prepareid,isjing,isgaokao,isdujia,beikao from tblSucai ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Maticsoft.Model.tblSucai model=new Maticsoft.Model.tblSucai();
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblSucai DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tblSucai model=new Maticsoft.Model.tblSucai();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tblSucai T ");
