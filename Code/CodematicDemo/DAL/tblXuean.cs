...
namespace Maticsoft.DAL
{
	...
	public partial class tblXuean
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "tblXuean"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from tblXuean");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Maticsoft.Model.tblXuean model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tblXuean(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Maticsoft.Model.tblXuean model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update tblXuean set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tblXuean ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblXuean GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,level,subjectid,versionid,name,uploadtime,filesrc,downloadnum,neednum,extension,year,uploader,content,prepareid,isjing,isgaokao,isdujia,beikao from tblXuean ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Maticsoft.Model.tblXuean DataRowToModel(DataRow row)
		{
			Maticsoft.Model.tblXuean model=new Maticsoft.Model.tblXuean();
			if (row != null)
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tblXuean T ");
